...
public class ListBoxLongSingletonDOMElementFactory extends ListBoxSingletonDOMElementFactory<Long, ListBox> {

    public ListBoxLongSingletonDOMElementFactory( final IGridLayer gridLayer,
