...
public class EnumSingleSelectBigDecimalUiColumn extends BaseEnumSingleSelectUiColumn<BigDecimal, ListBox, NumericBigDecimalTextBox, ListBoxDOMElement<BigDecimal, ListBox>, TextBoxDOMElement<BigDecimal, NumericBigDecimalTextBox>> {
    ...
    @Override
    protected void initialiseMultiValueDomElement( final IGridCell<BigDecimal> cell,
                                                   final GridBodyCellRenderContext context,
                                                   final Map<String, String> enumLookups ) {
        factory.attachDomElement( context,
                                  new Callback<ListBoxDOMElement<BigDecimal, ListBox>>() {
                                      @Override
                                      public void callback( final ListBoxDOMElement<BigDecimal, ListBox> e ) {
    ...
    @Override
    protected void initialiseSingleValueDomElement( final IGridCell<BigDecimal> cell,
                                                    final GridBodyCellRenderContext context ) {
