...
@Dependent
public class ActionWorkItemColumnSynchronizer extends ActionColumnSynchronizer {
    ...
    public List<BaseColumnFieldDiff> update( final ColumnMetaData originalMetaData,
        ...
        final boolean isHideUpdated = BaseColumnFieldDiffImpl.hasChanged( ActionWorkItemCol52.FIELD_HIDE_COLUMN,
                                                                          diffs );
        final boolean isHeaderUpdated = BaseColumnFieldDiffImpl.hasChanged( ActionWorkItemCol52.FIELD_HIDE_COLUMN,
                                                                            diffs );
