...
@Dependent
@Templated
public class EditMenuViewImpl extends Composite implements EditMenuView {

    private EditMenuBuilder presenter;
    ...
    @Override
    public void init( final EditMenuBuilder presenter ) {
