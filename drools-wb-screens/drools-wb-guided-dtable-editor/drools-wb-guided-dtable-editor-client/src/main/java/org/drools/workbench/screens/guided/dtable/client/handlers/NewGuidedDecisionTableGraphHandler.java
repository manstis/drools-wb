...
/**
 * Handler for the creation of new Guided Decision Table Graphs
 */
@ApplicationScoped
public class NewGuidedDecisionTableGraphHandler extends DefaultNewResourceHandler {
    ...
    @Inject
    public NewGuidedDecisionTableGraphHandler( final PlaceManager placeManager,
    ...
    public void create( final Package pkg,
        ...
        graphService.call( getSuccessCallback( presenter ),
                           new HasBusyIndicatorDefaultErrorCallback( busyIndicatorView ) ).create( pkg.getPackageMainResourcesPath(),
                                                                                                   buildFileName( baseFileName,
                                                                                                                  resourceType ),
                                                                                                   new GuidedDecisionTableEditorGraphModel(),
                                                                                                   "" );
    }
