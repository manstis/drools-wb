...
import org.uberfire.ext.wires.core.grids.client.widget.dom.single.BaseSingletonDOMElementFactory;
...
public abstract class MultiValueSingletonDOMElementFactory<T, W extends ListBox, E extends MultiValueDOMElement<T, W>> extends BaseSingletonDOMElementFactory<T, W, E> {
    ...
    public MultiValueSingletonDOMElementFactory( final IGridLayer gridLayer,
                                                 final GuidedDecisionTableView gridWidget ) {
        super( gridLayer,
               gridWidget );
    }

    public void toWidget( final IGridCell<T> cell,
                          final W widget ) {
