...
public class ListBoxBigDecimalSingletonDOMElementFactory extends ListBoxSingletonDOMElementFactory<BigDecimal, ListBox> {

    public ListBoxBigDecimalSingletonDOMElementFactory( final IGridLayer gridLayer,
