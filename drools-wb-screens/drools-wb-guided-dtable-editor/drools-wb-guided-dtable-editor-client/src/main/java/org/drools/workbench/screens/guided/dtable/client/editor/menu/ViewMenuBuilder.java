...
@ApplicationScoped
public class ViewMenuBuilder implements MenuFactory.CustomMenuBuilder,
    ...
    public void onDecisionTableSelectedEvent( final @Observes DecisionTableSelectedEvent event ) {
        ...
        if ( dtPresenter == null || !activeDecisionTable.getAccess().isEditable() ) {
            view.enableToggleMergedStateMenuItem( false );
            view.enableViewAuditLogMenuItem( false );
            ...
            view.setMerged( dtPresenter.isMerged() );
        }
    }
