...
public class TextBoxBigIntegerSingletonDOMElementFactory extends TextBoxSingletonDOMElementFactory<BigInteger, NumericBigIntegerTextBox> {
    ...
    public TextBoxBigIntegerSingletonDOMElementFactory( final IGridLayer gridLayer,
    ...
    @Override
    public NumericBigIntegerTextBox createWidget() {
        return new NumericBigIntegerTextBox( true );
    }
