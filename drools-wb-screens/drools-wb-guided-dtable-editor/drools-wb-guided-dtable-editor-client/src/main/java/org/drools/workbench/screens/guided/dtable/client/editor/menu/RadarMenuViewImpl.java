...
public class RadarMenuViewImpl extends Composite implements RadarMenuView {
    ...
    @Override
    public void setModellerBounds( final IBounds bounds ) {
    ...
    private Transform getTransform( final IBounds bounds ) {
    ...
    @Override
    public void setVisibleBounds( final IBounds bounds ) {
