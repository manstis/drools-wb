...
@Dependent
@Templated
public class CellContextMenuViewImpl extends Composite implements CellContextMenuView {

    private CellContextMenu presenter;
    ...
    @Override
    public void init( final CellContextMenu presenter ) {
