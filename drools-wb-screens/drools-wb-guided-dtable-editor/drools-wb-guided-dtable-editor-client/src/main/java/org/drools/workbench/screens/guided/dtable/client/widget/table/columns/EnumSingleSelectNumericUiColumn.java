...
public class EnumSingleSelectNumericUiColumn extends BaseEnumSingleSelectUiColumn<Number, ListBox, NumericBigDecimalTextBox, ListBoxDOMElement<Number, ListBox>, TextBoxDOMElement<Number, NumericBigDecimalTextBox>> {

    public EnumSingleSelectNumericUiColumn( final List<HeaderMetaData> headerMetaData,
                                            final double width,
                                            final boolean isResizable,
                                            final boolean isVisible,
                                            final GuidedDecisionTablePresenter.Access access,
                                            final MultiValueSingletonDOMElementFactory<Number, ListBox, ListBoxDOMElement<Number, ListBox>> multiValueFactory,
                                            final SingleValueSingletonDOMElementFactory<Number, NumericBigDecimalTextBox, TextBoxDOMElement<Number, NumericBigDecimalTextBox>> singleValueFactory,
    ...
    @Override
    protected void initialiseMultiValueDomElement( final IGridCell<Number> cell,
                                                   final GridBodyCellRenderContext context,
                                                   final Map<String, String> enumLookups ) {
        factory.attachDomElement( context,
                                  new Callback<ListBoxDOMElement<Number, ListBox>>() {
                                      @Override
                                      public void callback( final ListBoxDOMElement<Number, ListBox> e ) {
    ...
    @Override
    protected void initialiseSingleValueDomElement( final IGridCell<Number> cell,
                                                    final GridBodyCellRenderContext context ) {
