...
public class ListBoxByteSingletonDOMElementFactory extends ListBoxSingletonDOMElementFactory<Byte, ListBox> {

    public ListBoxByteSingletonDOMElementFactory( final IGridLayer gridLayer,
