...
public class ListBoxFloatSingletonDOMElementFactory extends ListBoxSingletonDOMElementFactory<Float, ListBox> {

    public ListBoxFloatSingletonDOMElementFactory( final IGridLayer gridLayer,
