...
@Dependent
public class ActionRetractFactCol52DefinitionBuilder extends BaseColumnDefinitionBuilder {

    @Inject
    public ActionRetractFactCol52DefinitionBuilder( final Caller<GuidedDecisionTableEditorService> service ) {
        super( service );
    }

    @Override
    public Class getSupportedColumnType() {
        return ActionRetractFactCol52.class;
    }
    ...
    public void generateDefinition( final GuidedDecisionTableView.Presenter dtPresenter,
        ...
        final ActionRetractFactCol52 arf = (ActionRetractFactCol52) column;
        partialModel.getActionCols().add( arf );
