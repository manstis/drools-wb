...
public class EnumSingleSelectByteUiColumn extends BaseEnumSingleSelectUiColumn<Byte, ListBox, NumericByteTextBox, ListBoxDOMElement<Byte, ListBox>, TextBoxDOMElement<Byte, NumericByteTextBox>> {
    ...
    @Override
    protected void initialiseMultiValueDomElement( final IGridCell<Byte> cell,
                                                   final GridBodyCellRenderContext context,
                                                   final Map<String, String> enumLookups ) {
        factory.attachDomElement( context,
                                  new Callback<ListBoxDOMElement<Byte, ListBox>>() {
                                      @Override
                                      public void callback( final ListBoxDOMElement<Byte, ListBox> e ) {
    ...
    @Override
    protected void initialiseSingleValueDomElement( final IGridCell<Byte> cell,
                                                    final GridBodyCellRenderContext context ) {
        singleValueFactory.attachDomElement( context,
                                             new Callback<TextBoxDOMElement<Byte, NumericByteTextBox>>() {
                                                 @Override
                                                 public void callback( final TextBoxDOMElement<Byte, NumericByteTextBox> e ) {
                                                     if ( hasValue( cell ) ) {
