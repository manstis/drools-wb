...
@Dependent
@Templated
public class InsertMenuViewImpl extends Composite implements InsertMenuView {

    private InsertMenuBuilder presenter;
    ...
    @Override
    public void init( final InsertMenuBuilder presenter ) {
