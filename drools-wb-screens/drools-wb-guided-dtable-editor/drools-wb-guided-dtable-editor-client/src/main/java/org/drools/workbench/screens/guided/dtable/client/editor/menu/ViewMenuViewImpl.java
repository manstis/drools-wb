...
@Dependent
@Templated
public class ViewMenuViewImpl extends Composite implements ViewMenuView {

    private ViewMenuBuilder presenter;
    ...
    @Override
    public void init( final ViewMenuBuilder presenter ) {
