...
@Dependent
public class ActionSetFieldCol52DefinitionBuilder extends BaseColumnDefinitionBuilder {
    ...
    public void generateDefinition( final GuidedDecisionTableView.Presenter dtPresenter,
        ...
        final ActionSetFieldCol52 asf = (ActionSetFieldCol52) column;
        partialModel.getActionCols().add( asf );
