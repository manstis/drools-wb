...
public class ListBoxShortSingletonDOMElementFactory extends ListBoxSingletonDOMElementFactory<Short, ListBox> {

    public ListBoxShortSingletonDOMElementFactory( final IGridLayer gridLayer,
