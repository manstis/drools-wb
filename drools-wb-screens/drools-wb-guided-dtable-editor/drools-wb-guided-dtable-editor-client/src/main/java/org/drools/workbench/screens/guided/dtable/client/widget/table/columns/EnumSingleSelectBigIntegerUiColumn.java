...
public class EnumSingleSelectBigIntegerUiColumn extends BaseEnumSingleSelectUiColumn<BigInteger, ListBox, NumericBigIntegerTextBox, ListBoxDOMElement<BigInteger, ListBox>, TextBoxDOMElement<BigInteger, NumericBigIntegerTextBox>> {
    ...
    @Override
    protected void initialiseMultiValueDomElement( final IGridCell<BigInteger> cell,
                                                   final GridBodyCellRenderContext context,
                                                   final Map<String, String> enumLookups ) {
        factory.attachDomElement( context,
                                  new Callback<ListBoxDOMElement<BigInteger, ListBox>>() {
                                      @Override
                                      public void callback( final ListBoxDOMElement<BigInteger, ListBox> e ) {
    ...
    @Override
    protected void initialiseSingleValueDomElement( final IGridCell<BigInteger> cell,
                                                    final GridBodyCellRenderContext context ) {
