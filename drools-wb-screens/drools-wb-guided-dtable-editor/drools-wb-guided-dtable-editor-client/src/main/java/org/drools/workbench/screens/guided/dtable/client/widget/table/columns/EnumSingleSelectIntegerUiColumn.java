...
public class EnumSingleSelectIntegerUiColumn extends BaseEnumSingleSelectUiColumn<Integer, ListBox, NumericIntegerTextBox, ListBoxDOMElement<Integer, ListBox>, TextBoxDOMElement<Integer, NumericIntegerTextBox>> {

    public EnumSingleSelectIntegerUiColumn( final List<HeaderMetaData> headerMetaData,
                                            final double width,
                                            final boolean isResizable,
                                            final boolean isVisible,
                                            final GuidedDecisionTablePresenter.Access access,
                                            final MultiValueSingletonDOMElementFactory<Integer, ListBox, ListBoxDOMElement<Integer, ListBox>> multiValueFactory,
                                            final SingleValueSingletonDOMElementFactory<Integer, NumericIntegerTextBox, TextBoxDOMElement<Integer, NumericIntegerTextBox>> singleValueFactory,
    ...
    @Override
    protected void initialiseMultiValueDomElement( final IGridCell<Integer> cell,
                                                   final GridBodyCellRenderContext context,
                                                   final Map<String, String> enumLookups ) {
        factory.attachDomElement( context,
                                  new Callback<ListBoxDOMElement<Integer, ListBox>>() {
                                      @Override
                                      public void callback( final ListBoxDOMElement<Integer, ListBox> e ) {
    ...
    @Override
    protected void initialiseSingleValueDomElement( final IGridCell<Integer> cell,
                                                    final GridBodyCellRenderContext context ) {
