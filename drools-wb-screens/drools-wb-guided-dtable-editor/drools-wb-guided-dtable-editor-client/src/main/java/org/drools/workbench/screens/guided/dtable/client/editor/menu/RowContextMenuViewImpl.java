...
@Dependent
@Templated
public class RowContextMenuViewImpl extends Composite implements RowContextMenuView {

    private RowContextMenu presenter;
    ...
    @Override
    public void init( final RowContextMenu presenter ) {
