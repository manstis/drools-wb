...
public class ActionWorkItemSetFieldColumnSynchronizerTest extends BaseSynchronizerTest {
    ...
    public void testMoveColumnTo_MoveLeft() throws ModelSynchronizer.MoveColumnVetoException {
        ...
        assertEquals( 5,
                      uiModel.getColumns().size() );
        final IGridColumn<?> uiModelColumn1_1 = uiModel.getColumns().get( 3 );
        final IGridColumn<?> uiModelColumn2_1 = uiModel.getColumns().get( 4 );
        assertEquals( "wid1",
        ...
        assertEquals( 5,
                      uiModel.getColumns().size() );
        final IGridColumn<?> uiModelColumn1_2 = uiModel.getColumns().get( 3 );
        final IGridColumn<?> uiModelColumn2_2 = uiModel.getColumns().get( 4 );
        assertEquals( "wid2",
