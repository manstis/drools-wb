...
import org.roger600.lienzo.mockito.annotation.Translators;
import org.roger600.lienzo.mockito.translator.ViewportClassTranslatorInterceptor;
...
@Translators(ViewportClassTranslatorInterceptor.class)
public class RadarMenuBuilderTest {
    ...
    @Mock
    private IGridLayer modellerLayer;
    ...
    public void testOnUpdateRadarEventNullModeller() {
        ...
        verify( view,
                never() ).setVisibleBounds( any( IBounds.class ) );
    }
