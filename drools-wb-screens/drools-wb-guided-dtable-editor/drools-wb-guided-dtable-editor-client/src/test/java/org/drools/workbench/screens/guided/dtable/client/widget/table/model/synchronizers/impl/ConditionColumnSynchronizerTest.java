...
public class ConditionColumnSynchronizerTest extends BaseSynchronizerTest {
    ...
    public void testMoveColumnsTo_MoveLeft() throws ModelSynchronizer.MoveColumnVetoException {
        ...
        final IGridColumn<?> uiModelColumn2_1 = uiModel.getColumns().get( 3 );
        final IGridColumn<?> uiModelColumn3_1 = uiModel.getColumns().get( 4 );
        final IGridColumn<?> uiModelColumn4_1 = uiModel.getColumns().get( 5 );
        assertEquals( "$a : Applicant",
                      uiModelColumn1_1.getHeaderMetaData().get( 0 ).getTitle() );
        assertEquals( "$a : Applicant",
                      uiModelColumn2_1.getHeaderMetaData().get( 0 ).getTitle() );
        ...
        final IGridColumn<?> uiModelColumn2_2 = uiModel.getColumns().get( 3 );
        final IGridColumn<?> uiModelColumn3_2 = uiModel.getColumns().get( 4 );
        final IGridColumn<?> uiModelColumn4_2 = uiModel.getColumns().get( 5 );
        assertEquals( "$d : Address",
                      uiModelColumn1_2.getHeaderMetaData().get( 0 ).getTitle() );
        assertEquals( "$d : Address",
                      uiModelColumn2_2.getHeaderMetaData().get( 0 ).getTitle() );
    ...
    public void testMoveColumnsTo_MoveLeft_MidPoint() throws ModelSynchronizer.MoveColumnVetoException {
        ...
        final IGridColumn<?> uiModelColumn3_1 = uiModel.getColumns().get( 4 );
        final IGridColumn<?> uiModelColumn4_1 = uiModel.getColumns().get( 5 );
        final IGridColumn<?> uiModelColumn5_1 = uiModel.getColumns().get( 6 );
        final IGridColumn<?> uiModelColumn6_1 = uiModel.getColumns().get( 7 );
        assertEquals( "$a : Applicant",
                      uiModelColumn1_1.getHeaderMetaData().get( 0 ).getTitle() );
        assertEquals( "$a : Applicant",
                      uiModelColumn2_1.getHeaderMetaData().get( 0 ).getTitle() );
        ...
        final IGridColumn<?> uiModelColumn3_2 = uiModel.getColumns().get( 4 );
        final IGridColumn<?> uiModelColumn4_2 = uiModel.getColumns().get( 5 );
        final IGridColumn<?> uiModelColumn5_2 = uiModel.getColumns().get( 6 );
        final IGridColumn<?> uiModelColumn6_2 = uiModel.getColumns().get( 7 );
        assertEquals( "$a : Applicant",
                      uiModelColumn1_2.getHeaderMetaData().get( 0 ).getTitle() );
        assertEquals( "$a : Applicant",
                      uiModelColumn2_2.getHeaderMetaData().get( 0 ).getTitle() );
